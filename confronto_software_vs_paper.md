...
**Versione**: v3.3.0 — con cessation detection, consensus FPD, smart classification, UI modulare, logging strutturato, pesi configurabili, refactoring core, fix denominatore re-analisi, CI, test e2e
